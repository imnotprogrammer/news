...
class BaseController extends Controller{
    ...
    public function indexAction(){
        header('location:/author/base/setgen');    
    }
	public function messageAction(){
		$this->display("author/message.tpl");
	}
    ...
    public function setphoneAction(){
         if($_POST){
            ...
            $this->display('author/set_phone.tpl');
        }
    }
    ...
    public function setpwdAction(){
      if($_POST){
            ...
            $this->display('author/set_pass.tpl');
        }
	...
	public function setkeyAction(){
      if($_POST){
            ...
            $this->display('author/set_protect.tpl');
        }
    ...
    public function setemailAction(){
        if($_POST){
            ...
            $this->display('author/set_email.tpl');
        }
        
    }
	public function setProtectKeyAction(){
		if($_POST){}
	}
}
