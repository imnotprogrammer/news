...
.file{ position:absolute; top:5px;right:30px; height:20px; width:80px; filter:alpha(opacity:0);opacity: 0;}
    ...
    <div id="m_right">
	   <div id="step_form">
        ...
        <form action="/user/index/setgen" method="post" class="form_common" id="gen_from" enctype="multipart/form-data">
		
		 <p style="width:128px;height:128px;">

              <label><img src="{if $userlist.ui_header}{$userlist.ui_header}{else}/res/img/user.jpg{/if}" width="128px" height="128px" style="border:1px solid white;"/></label>
