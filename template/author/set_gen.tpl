...
.file{ position:absolute; top:5px;right:30px; height:20px; width:80px; filter:alpha(opacity:0);opacity: 0;}
    ...
    <div id="m_right">
	   <div id="step_form">
        ...
        <form action="/author/base/setgen" method="post" class="form_common" id="gen_from" enctype="multipart/form-data">
		 ...
		 <p style="width:128px;height:128px;">
          ...
          <p>
            ...
            <input id="updateuser" type="submit" value="保存" class="btn " style="width:70px;height:35px;border:1px solid white;line-height:35px;color:white;border-radius:4px;background-color: rgb(66, 160, 121);">
          </p>
        </form>
      </div>
{/block}
