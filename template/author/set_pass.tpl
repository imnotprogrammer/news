...
{block name="main"}
    ...
    <div id="m_right">
        ...
        <form action="/author/base/setpwd" class="form_common" id="gen_from" name="editForm">
          <div id="step1">
              <p>
			  ...
			  <p>
                ...
                <label>确认新密码:</label>
                <input type="password"  class="require" title="确实新密码不能为空！"  name="surepass" style="border-radius:4px;border:1px solid gray;">          
              </p>
              <p>
                <label>&nbsp;</label>
